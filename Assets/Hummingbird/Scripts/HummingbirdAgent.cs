...
public class HummingbirdAgent : Agent
{
    ...
    public override void Initialize()
    {
        ...
        //If not traing mode, no max step, play forever
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //Observe the agent큦 local rotation (4 observations)
    ...
    /// <summary>
    /// When Behavior Type is set to "Heuristic Only" on the agent큦 Behavior Parameters,
    ...
    /// <summary>
    /// Move the agent to a safe eandom position (i.e. does not collide with anything)
    ...
    private void MoveToSafeRandomPosition(bool inFrontOfFlower)
    {
        ...
        while(!safePositionFound && attemptsRemaining > 0)
        {
            ...
            if(inFrontOfFlower)
            {
                ...
                //Point beak at flower (bird큦 head  is center of transform)
            ...
            {
                //Pick an random height from the ground
            ...
            //Safe position hs been found if no colliders are overlapped
    ...
    /// <summary>
    /// Called when the agent큦 collider enters a trigger collider
    /// </summary>
    ...
    /// <summary>
    /// Called when the agent큦 collider stays in a trigger collider
    /// </summary>
    /// <param name="other">The trigger collider</param>
    ...
    /// <summary>
    /// Handles when the agent큦 collider enters or stays in a trigger collider
    /// </summary>
    ...
    private void TriggerEnterOrStay(Collider collider)
    {
        ...
        if (collider.CompareTag("nectar"))
        {
            ...
            //Note: a colision with anything but the beak tip should not count
